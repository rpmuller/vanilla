...
Jobs = [
    {
        "Company": "IonQ",
        "Positions": [
            {"Title": "SVP, Federal Technical Lead", "Span": "2025-Present"},
            {"Title": "VP, Quantum Computing Systems", "Span": "2025"}],
        "Summary": "Developing IonQ's next generation quantum systems to address the world's hardest problems."
    },
